...
class IntermediateIssueWorkOrderDetailsAdapter(val intermediateMaterialsList: List<IntermediateMaterial>) :
    Adapter<IntermediateIssueWorkOrderDetailsAdapter.IntermediateWorkOrderDetailsViewHolder>() {
        ...
        with(holder.binding) {
            ...
            if (material.isSerializedWithOneSerial) {
                ...
                if (material.isSerialized) {
                    ...
                    val receivedPerIssued = "${material.issuedQuantity}"
