...
class PutAwayWorkOrderListViewModel(private val application: Application, activity: Activity) :
    ...
    fun getWorkOrderList() {
        ...
        viewModelScope.launch {
            try {
                val response = repository.getPutAwayWorkOrdersList(USER_ID, deviceSerialNo, lang)
                ResponseDataHandler(
                    response,
                    getWorkOrderList,
