...
import net.gbs.schneider.databinding.IntermediateReceivingWorkOrderItemBinding

class IntermediateReceivingWorkOrdersAdapter(private val onItemButtonsClicked: OnItemButtonsClicked) :
    RecyclerView.Adapter<IntermediateReceivingWorkOrdersAdapter.IntermediateReceivingWorkOrdersViewHolder>(),
    Filterable {

    inner class IntermediateReceivingWorkOrdersViewHolder(itemView: View) : ViewHolder(itemView) {
        val binding = IntermediateReceivingWorkOrderItemBinding.bind(itemView)
    }
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): IntermediateReceivingWorkOrdersViewHolder {
        val binding = IntermediateReceivingWorkOrderItemBinding.inflate(
            LayoutInflater.from(parent.context),
            parent,
            false
        )
        return IntermediateReceivingWorkOrdersViewHolder(binding.root)
    }
    ...
    override fun onBindViewHolder(
        holder: IntermediateReceivingWorkOrdersViewHolder,
        position: Int
    ) {
        ...
        with(holder) {
            ...
            binding.startReceiving.setOnClickListener {
                onItemButtonsClicked.OnStartReceivingButtonClicked(workOrder)
            }
    ...
    interface OnItemButtonsClicked {
        fun OnStartReceivingButtonClicked(workOrder: IntermediateWorkOrder)
        fun OnDetailsButtonClicked(workOrder: IntermediateWorkOrder)
    }
