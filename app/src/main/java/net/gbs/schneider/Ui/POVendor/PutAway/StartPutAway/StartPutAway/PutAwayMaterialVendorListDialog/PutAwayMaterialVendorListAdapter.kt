...
class PutAwayMaterialVendorListAdapter(
    private val materialList: List<VendorMaterial>,
    val onMaterialItemClicked: OnMaterialItemClicked
) : Adapter<PutAwayMaterialVendorListAdapter.MaterialViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MaterialViewHolder, position: Int) {
        ...
        with(holder) {
            ...
            binding.shippedQty.text = materialItem.acceptedQty.toString()
