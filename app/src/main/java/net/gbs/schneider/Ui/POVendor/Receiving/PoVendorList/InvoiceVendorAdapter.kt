...
import net.gbs.schneider.databinding.InvoiceVendorItemLayoutBinding

class InvoiceVendorAdapter(private val onItemButtonsClicked: OnItemButtonsClicked) :
    Adapter<InvoiceVendorAdapter.InvoiceViewHolder>(), Filterable {
    ...
    inner class InvoiceViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val binding = InvoiceVendorItemLayoutBinding.bind(itemView)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): InvoiceViewHolder {
        val binding = InvoiceVendorItemLayoutBinding.inflate(
    ...
    interface OnItemButtonsClicked {
        fun OnStartReceivingButtonClicked(invoice: InvoiceVendor)
